      ...
      <div className='space-y-6'>
        <div className='text-center'>
          ...
          <p className='text-gray-600 mb-4'>
            Draw the prompt and others will guess what it is. Be fast and
            creative!
          </p>
        </div>
          ...
          <div className='space-y-1 max-h-32 overflow-y-auto'>
            {currentRoundData.guesses
              ...
              .map((guessData: any, index: number) => (
                <div
                  key={index}
                  className={`text-sm ${guessData.isCorrect ? 'text-green-600 font-semibold' : 'text-gray-600'}`}
                >
                  <span className='font-medium'>
                    {getPlayerName(guessData.playerId)}:
                  </span>{' '}
                  {guessData.guess}
                  {guessData.isCorrect && ' ✓'}
                </div>
